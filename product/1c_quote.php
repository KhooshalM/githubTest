...
PKG_PREMIUM.TOTAL_PREMIUM_1C(
   ...
   :BP,:ADLOA, :NC, :EP,  :TW,  :MED_CRI,  :OTH,  :VIP,  :TL,  :V_POLICY_FEE,  :TOT_PREM, :NO_DAYS,:C_MED_STATUS,:C_CRI_STATUS,:C_WAR_STATUS,:C_WAR_SCH,:HRL);
...
oci_bind_by_name($sidwk,':C_WAR_STATUS',$war_status,40);
oci_bind_by_name($sidwk,':C_WAR_SCH',$schedule,40);
