...
<div class="content-wrapper">
    ...
    <div class="box box-danger">
            ...
            <div class="box-body">
              ...
              <input type="text" class="form-control"  id="suminsured" name="suminsured" onkeypress="return onlyNumberKey(event)" value="<?php echo $sum_insured  ?>">
  ...
  <div class="box-body">
          ...
          <select class="form-control select2" style="width: 100%;"  name="fuel_type" id="fuel_types"  required onchange="displayDivDemo('hideValuesOnSelect', this)">
             ...
             <label for="exampleInputaddress">Engine No</label>
              ...
              <option value="">- Select - </option> 
                  <?php 
                   ...
                   <option value="<?php echo $rft_code; ?>"> <?php echo $desc; ?> - <?php echo $rft_code; ?> </option>
                   <?php } ?>
          </select>
            </div>
                </div>
  ...
  <div class="box-body">
          ...
          <input type="text" class="form-control"  style="display: block;" name="kilowat" id="kilowat">
          </div>
                </div>
