                 ...
                 <table id="salesreporttable" class="table table-striped">
                        ...
                        <tbody>
                           ...
                           (SELECT c.mtq_period_form FROM me_t_quotation c WHERE c.mtb_seq=A.mtb_seq)AS MTQ_PERIOD_FORM
                            ...
                            AND mtb_bus_status='N' -- N = new policy
                            ...
                            ?>
                               ...
                               <!-- <td> <button class="btn btn-<?php if($type_of_prospective=="PROSPECTIVE") { echo "success";} else { echo"danger"; } ?> btn-xs"><?php echo $type_of_prospective ?></button></td>-->
                                ...
                                <?php if($quo_seq ==""){ ?>
                                <a href="<?php if($class=="MC" || $class=="M3"){ echo "quotation1.php"; } else { echo "quotation2.php";  }?>?bus_id=<?php echo  $seq  ?>&cus_id=<?php echo $mmc_id ?>&pol_sts=<?php  echo "N"; ?>" class="btn-quotation btn bg-black margin btn-sm">Quotation</a>
                                </td>
                                  <?php }
                                    else { echo "<a href='update_quotation.php?quo_id=$quo_seq&pol_sts=N' class='btn-quotation btn bg-green margin btn-sm'>Update Quote</button>"; } ?>
                                ...
                                <?php if($quo_seq ==""){
                                    ...
                                    echo " <button type='button' data-id='$quo_seq' class='btn-quotation btn bg-purple margin btn-sm'><i class='fa fa-fw fa-eye'></i></i></button>";
                                }
                                ...
                                <?php if($quo_seq ==""){
                                    ...
                                    echo " <button type='button' data-id='$seq&pol_sts=R' class='btn-finalise btn btn-success  pull-right'><i class='fa fa-fw fa-check-square-o'></i></button>";
                                }
