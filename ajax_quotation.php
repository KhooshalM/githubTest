          ...
          <div class="table-responsive bg-warning">
            <table class="table">
              ...
              <tr>
                ...
                <input type="hidden" id="polsts" value="<?php echo $polsts ?>">
              </tr>
              <?php } 
              else {
...
<div class="modal-footer">
                ...
                <button type="button" class="btn-save btn btn-outline" id="save">Save changes</button>
              </div>
...
$('#save').click(function(){
  ...
  var polsts = $('#polsts').val();
  
  var total_prm = $('#total_prm').val();


                        $.ajax({
                        url: 'insert_quotation.php',
                        type: 'POST',
                    ...
                    button: "Ok",
                     ...
                     if(response==2){
                      jQuery(function validation(){
                     swal({
                     title: "Issue With Quotation - Contact IT DEPT",
                     text: "Quotation  NOT Added",
                     icon: "error",
                     button: "Ok",
                      });
                      });
                     ...
                     if(response==3){
                      //alert("Quotation Already Exists - Proceed To Update")
                      jQuery(function validation(){
                     swal({
                     title: "Warning",
                     text: "Quotation Record Already Exist - Proceed to Update",
                     icon: "warning",
                     button: "Ok",
                      });
                      });
